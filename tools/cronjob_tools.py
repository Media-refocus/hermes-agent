    ...
    "parameters": {
        ...
        "properties": {
            ...
            "reasoning_effort": {
                ...
                "description": "Optional per-job reasoning effort override for LLM-driven cron jobs. Use medium for premium governance consolidation; high only for risky apply/conflict decisions. When unset, inherits profile agent.reasoning_effort. On update, pass an empty string to clear."
            },
            "no_agent": {
                "type": "boolean",
                "default": False,
