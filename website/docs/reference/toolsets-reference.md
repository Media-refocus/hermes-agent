...
| `file_readonly` | `read_file`, `search_files` | Read and search files without exposing write or patch operations. |
...
| `skills_readonly` | `skill_view`, `skills_list` | Browse and read skills without exposing skill management. |
